function SIFigure_Test(testName,ts,testNameAll)
...
if(strcmp(testName,'BinaxNOW')) 
    ...
    S = TestSensitivity(t,ts,inf,beta,betaRTPCR);  
...
elseif(strcmp(testName,'BinaxNOW (Community)'))
    ...
    S2 = TestSensitivity(t,ts,inf,beta,betaRTPCR);
...
if(strcmp(testName,'BinaxNOW')) 
    ...
    S = TestSensitivityOLD(t,ts,inf,beta,0);  
 ...
 elseif(strcmp(testName,'BinaxNOW (Community)')) 
    ...
    S2 = TestSensitivityOLD(t,ts,inf,beta,0);
    [CCtest2,SymP2]= ColourTests(testNameAll{fff});
    CCtest2=CCtest2(1,:);    
