...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('Testing_Frequency_RTPCR_NatComm.mat')
...
for dd=1:5
    load([num2str(dd) '-day_Delay_Testing_Frequency_RTPCR_NatComm.mat']);
...
xlim([7.5*10^(-4) 0.5]);
ylim([0 1.7]);
% text(0.000398349130709,1.70599294947121,'A','Fontsize',32,'FontWeight','bold');
print(gcf,['FigureS4A.png'],'-dpng','-r600');
