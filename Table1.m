...
for ii=1:Ntest
    [Quarantine_Duration_Exit(ii,:),Quarantine_Duration_Entry_Exit(ii,:),Serial_Testing_Freq(ii),False_Positive_Risk(ii)] = Quarantine_Testing_Freq(testName{ii},pA,DurT,'Baseline');
end
