...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load([num2str(0) '-day_Delay_Testing_Frequency_RTPCR_General.mat']);
...
for dd=1:5
    load([num2str(dd) '-day_Delay_Testing_Frequency_RTPCR_General.mat']);
...
print(gcf,['Figure4_Non_Delta.png'],'-dpng','-r600');
