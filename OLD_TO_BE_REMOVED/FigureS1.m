...
t=linspace(0,40,1001);
 ...
 S = TestSensitivityOLD(t,ts,tL,inf,[],0); 
...
set(gca,'LineWidth',2,'tickdir','out','Fontsize',20,'XTick',[0:2:40],'xlim',[0 40],'XMinorTick','on','Yminortick','on','YTick',[0:0.2:1],'Ylim',[0 1]);
...
legend boxoff;
print(gcf,['FigureS1.png'],'-dpng','-r600');