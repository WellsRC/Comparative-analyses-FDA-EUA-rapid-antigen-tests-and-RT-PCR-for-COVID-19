...
tfr=7+(12-fr);
text(-2.699383553973718,1.489425287356321,char(58+tfr),'Fontsize',34,'FontWeight','bold');
if(rem(fr,2)==1)
    print(gcf,['Alltests_Testing_Frequency=' num2str(fr) '_NatComm.png'],'-dpng','-r600');
end
end
