function S = TestSensitivity_Case_Estimate(t,ts,testtype,beta,td,spc)
...
S(t>=td)=1-spc; % If it exceeds the duration of ifnection; individual is no longer infectious and thus should only be based on the specificity of the test in terms of the identification
end
