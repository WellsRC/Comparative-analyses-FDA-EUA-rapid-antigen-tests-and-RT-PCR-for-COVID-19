...
for delayTR=0:5
    ...
    save([num2str(delayTR) '-day_Delay_Testing_Frequency_RTPCR_DeltaVOC_Alternative_PCR.mat']);
end
...
for delayTR=0:5
    ...
    save([num2str(delayTR) '-day_Delay_Testing_Frequency_RTPCR_DeltaVOC_Alternative_PCR_Uncertainty.mat']);
end
