...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load([num2str(0) '-day_Delay_Testing_Frequency_RTPCR_DeltaVOC_Alternative_PCR.mat']);
...
for dd=1:5
    load([num2str(dd) '-day_Delay_Testing_Frequency_RTPCR_DeltaVOC_Alternative_PCR.mat']);
...
print(gcf,['Figure4_Alternative_PCR_Curve.png'],'-dpng','-r600');
