...
Risk=1;
R=zeros(14,6);
load('TestingonExit_RTPCR_24hrDelay_DeltaVOC_Alternative_PCR.mat')
R(:,1)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonExit_RTPCR_24hrDelay_DeltaVOC_Alternative_PCR_Uncertainty.mat')
RTPCR_Un=Probability_Onward((1-pA).*IDSLSv+pA.*IDSLAv,Risk);

load('TestingonExit_LumiraDX (Anterior Nasal Swab)_NoDelay_DeltaVOC_Alternative_PCR.mat')
R(:,2)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonExit_Sofia (FDA)_NoDelay_DeltaVOC_Alternative_PCR.mat')
R(:,3)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonExit_BinaxNOW (FDA)_NoDelay_DeltaVOC_Alternative_PCR.mat')
R(:,4)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonExit_BD Veritor_NoDelay_DeltaVOC_Alternative_PCR.mat')
R(:,5)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonExit_CareStart (Anterior Nasal Swab - FDA)_NoDelay_DeltaVOC_Alternative_PCR.mat')
...
for kk=1:NumTest
    load(['TestingonExit_' testName{kk} '_NoDelay_DeltaVOC_Alternative_PCR.mat'],'IDSLS','IDSLA');
    RAllAgTest(:,kk)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);
    load(['TestingonExit_' testName{kk} '_NoDelay_DeltaVOC_Alternative_PCR_Uncertainty.mat'],'IDSLSv','IDSLAv');
...
load('TestingonEntryExit_LumiraDX (Anterior Nasal Swab)_NoDelay_DeltaVOC_Alternative_PCR.mat')
R(:,2)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonEntryExit_Sofia (FDA)_NoDelay_DeltaVOC_Alternative_PCR.mat')
R(:,3)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonEntryExit_BinaxNOW (FDA)_NoDelay_DeltaVOC_Alternative_PCR.mat')
R(:,4)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonEntryExit_BD Veritor_NoDelay_DeltaVOC_Alternative_PCR.mat')
R(:,5)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonEntryExit_CareStart (Anterior Nasal Swab - FDA)_NoDelay_DeltaVOC_Alternative_PCR.mat')
R(:,6)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);
...
for kk=1:NumTest
    load(['TestingonEntryExit_' testName{kk} '_NoDelay_DeltaVOC_Alternative_PCR.mat'],'IDSLS','IDSLA');
    RAllAgTest(:,kk)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);
    load(['TestingEntryExit_' testName{kk} '_NoDelay_DeltaVOC_Alternative_PCR_Uncertainty.mat'],'IDSLSv','IDSLAv');
    RAllAgTest_Un(:,:,kk)=Probability_Onward((1-pA).*IDSLSv+pA.*IDSLAv,Risk);
end
