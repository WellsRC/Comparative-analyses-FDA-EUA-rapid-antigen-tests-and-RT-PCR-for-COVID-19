...
addpath([pwd '\Delta_Variant_Swapped']);
addpath([pwd '\Delta_Variant_Swapped\Results']);
...
rmpath([pwd '\Delta_Variant_Swapped']);
rmpath([pwd '\Delta_Variant_Swapped\Results']);

% print(gcf,'Figure2_Swapped','-dpng','-r300');
