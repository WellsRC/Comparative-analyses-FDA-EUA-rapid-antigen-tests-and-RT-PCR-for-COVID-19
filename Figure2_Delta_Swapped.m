...
addpath([pwd '\Delta_Variant_Swapped_Fixed']);
addpath([pwd '\Delta_Variant_Swapped_Fixed\Results']);
...
Risk=1;
R=zeros(14,6);
load('TestingonExit_RTPCR_24hrDelay_DeltaVOC_Sensitivity_Swap.mat')
R(:,1)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonExit_LumiraDX (Anterior Nasal Swab)_NoDelay_DeltaVOC_Sensitivity_Swap.mat')
R(:,2)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonExit_Sofia (FDA)_NoDelay_DeltaVOC_Sensitivity_Swap.mat')
R(:,3)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonExit_BinaxNOW (FDA)_NoDelay_DeltaVOC_Sensitivity_Swap.mat')
R(:,4)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonExit_BD Veritor_NoDelay_DeltaVOC_Sensitivity_Swap.mat')
R(:,5)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonExit_CareStart (Anterior Nasal Swab - FDA)_NoDelay_DeltaVOC_Sensitivity_Swap.mat')
...
for kk=1:NumTest
    load(['TestingonExit_' testName{kk} '_NoDelay_DeltaVOC_Sensitivity_Swap.mat'],'IDSLS','IDSLA');
...
load('TestingonEntryExit_LumiraDX (Anterior Nasal Swab)_NoDelay_DeltaVOC_Sensitivity_Swap.mat')
R(:,2)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonEntryExit_Sofia (FDA)_NoDelay_DeltaVOC_Sensitivity_Swap.mat')
R(:,3)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonEntryExit_BinaxNOW (FDA)_NoDelay_DeltaVOC_Sensitivity_Swap.mat')
R(:,4)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonEntryExit_BD Veritor_NoDelay_DeltaVOC_Sensitivity_Swap.mat')
R(:,5)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);

load('TestingonEntryExit_CareStart (Anterior Nasal Swab - FDA)_NoDelay_DeltaVOC_Sensitivity_Swap.mat')
R(:,6)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);
...
for kk=1:NumTest
    load(['TestingonEntryExit_' testName{kk} '_NoDelay_DeltaVOC_Sensitivity_Swap.mat'],'IDSLS','IDSLA');
    RAllAgTest(:,kk)=Probability_Onward((1-pA).*IDSLS+pA.*IDSLA,Risk);
end
...
rmpath([pwd '\Delta_Variant_Swapped_Fixed']);
rmpath([pwd '\Delta_Variant_Swapped_Fixed\Results']);

% print(gcf,'Figure2_Swapped_Fixed','-dpng','-r300');
